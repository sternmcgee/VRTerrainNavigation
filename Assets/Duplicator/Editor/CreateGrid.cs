...
public class GridCreator : EditorWindow {
	...
	[MenuItem ("Duplicator/Create 2D Grid")]
	static void Init () 
	{
		GridCreator window = (GridCreator)EditorWindow.GetWindow (typeof (GridCreator));
		window.Show();
	}
	...
	{
		GameObject GridHandle = new GameObject ("2D Grid Parent");
